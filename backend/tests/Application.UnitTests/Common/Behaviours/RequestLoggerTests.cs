using CleanArchitectureApi.Application.Common.Behaviours;
...
namespace CleanArchitectureApi.Application.UnitTests.Common.Behaviours;
...
public class RequestLoggerTests
{
    ...
    public async Task ShouldCallGetUserNameAsyncOnceIfAuthenticated()
    {
        ...
        await requestLogger.Process(new CreateProductItemCommand { ListId = 1, Title = "title" }, new CancellationToken());
